...
import { Loader2, Star, Search, Handshake, CheckCircle2, Upload, MessageCircle, Wallet } from 'lucide-react';
  ...
  return (
    <div className="bg-gray-100 min-h-screen pb-10">
      ...
      <div className="max-w-[1500px] mx-auto px-4 -mt-16 sm:-mt-24 relative z-20">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8 border-t-4 border-[#febd69]">
          <h2 className="text-xl font-bold text-gray-900 mb-6 text-center">How NSEC Cart Works</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 relative">
            ...
            {/* Buying Process */}
            <div>
               <h3 className="font-bold text-lg text-blue-700 mb-4 flex items-center justify-center md:justify-start">
                 <Search className="h-5 w-5 mr-2" /> For Buyers
               </h3>
               <div className="space-y-4">
                  <div className="flex gap-3">
                    <div className="flex-shrink-0 bg-blue-100 h-8 w-8 rounded-full flex items-center justify-center font-bold text-blue-700 text-sm">1</div>
                    <div>
                      <p className="font-bold text-sm text-gray-900">Place an Order</p>
                      <p className="text-xs text-gray-600">Find an item and click "Place Order". No payment is needed yet.</p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <div className="flex-shrink-0 bg-blue-100 h-8 w-8 rounded-full flex items-center justify-center font-bold text-blue-700 text-sm">2</div>
                    <div>
                      <p className="font-bold text-sm text-gray-900">Wait for Acceptance</p>
                      <p className="text-xs text-gray-600">The seller receives your request. Once they click <strong>Accept</strong>, the item is reserved for you.</p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <div className="flex-shrink-0 bg-blue-100 h-8 w-8 rounded-full flex items-center justify-center font-bold text-blue-700 text-sm">3</div>
                    <div>
                      <p className="font-bold text-sm text-gray-900">Meet & Pay</p>
                      <p className="text-xs text-gray-600">Connect on WhatsApp, meet on campus, check the item, and pay cash/UPI directly.</p>
                    </div>
                  </div>
               </div>
            </div>
            ...
            {/* Selling Process */}
            <div>
               <h3 className="font-bold text-lg text-green-700 mb-4 flex items-center justify-center md:justify-start">
                 <Wallet className="h-5 w-5 mr-2" /> For Sellers
               </h3>
               <div className="space-y-4">
                  <div className="flex gap-3">
                    <div className="flex-shrink-0 bg-green-100 h-8 w-8 rounded-full flex items-center justify-center font-bold text-green-700 text-sm">1</div>
                    <div>
                      <p className="font-bold text-sm text-gray-900">List Your Item</p>
                      <p className="text-xs text-gray-600">Upload a photo and details. It takes less than 30 seconds.</p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <div className="flex-shrink-0 bg-green-100 h-8 w-8 rounded-full flex items-center justify-center font-bold text-green-700 text-sm">2</div>
                    <div>
                      <p className="font-bold text-sm text-gray-900">Accept Orders</p>
                      <p className="text-xs text-gray-600">Check "My Orders". Click <strong>Accept</strong> to confirm a buyer. This marks the item as "Reserved".</p>
                    </div>
                  </div>
                  <div className="flex gap-3">
                    <div className="flex-shrink-0 bg-green-100 h-8 w-8 rounded-full flex items-center justify-center font-bold text-green-700 text-sm">3</div>
                    <div>
                      <p className="font-bold text-sm text-gray-900">Exchange</p>
                      <p className="text-xs text-gray-600">Coordinate a meeting spot on campus, hand over the item, and get paid.</p>
                    </div>
                  </div>
               </div>
            </div>
